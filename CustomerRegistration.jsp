...
try {
   ...
   PreparedStatement s=con.prepareStatement("INSERT INTO CustomerRegister"  
		   +"(Password,ConfirmPassword,FirstName,LastName,Gender,Age,TelephoneNo,MobileNo,Email,Address,Pincode,AnnualIncome) VALUES"
		   +"(?,?,?,?,?,?,?,?,?,?,?,?)" );
   ...
   // s.setString(13,UserId);
    ...
    out.println("<font color=red size=7>User Details Inserted  </font><BR/><BR/>");
